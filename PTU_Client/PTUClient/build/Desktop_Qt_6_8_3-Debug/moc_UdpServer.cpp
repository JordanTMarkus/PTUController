...
Q_CONSTINIT static const uint qt_meta_data_ZN9UdpServerE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       7,   10,   45,    2, 0x06,    5 /* Public */,
      12,    1,   66,    2, 0x06,   16 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      14,    0,   69,    2, 0x08,   18 /* Private */,

 // signals: parameters
    QMetaType::Void, QMetaType::QByteArray, 0x80000000 | 4, QMetaType::UShort,    3,    5,    6,
    QMetaType::Void, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Double, QMetaType::Double, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int,    8,    9,   10,   11,    2,    2,    2,    2,    2,    2,
...
void UdpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendClientData((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[5])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[6])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[7])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[8])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[9])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[10]))); break;
        case 2: _t->processDatagram((*reinterpret_cast< std::add_pointer_t<QNetworkDatagram&>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (UdpServer::*)(const QByteArray & , QHostAddress & , quint16 );
        ...
        {
            using _q_method_type = void (UdpServer::*)(int , int , int , int , double , double , int , int , int , int );
            if (_q_method_type _q_method = &UdpServer::sendClientData; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void UdpServer::datagramReceived(const QByteArray & _t1, QHostAddress & _t2, quint16 _t3)
{
...
// SIGNAL 1
void UdpServer::sendClientData(int _t1, int _t2, int _t3, int _t4, double _t5, double _t6, int _t7, int _t8, int _t9, int _t10)
{
